/* Form validation java script from : https://www.codehim.com/text-input/contact-form-validation-in-javascript/ */
        ...
        if (fields[i].value === "") {
            ...
            errArr.push(fields[i]);
             ...
             if (fields[i].id !== 'email' && fields[i].id !== 'phone') {
                ...
                if(val === false) {
                  fields[i].nextElementSibling.innerHTML = "Please type a proper message!";
                  fields[i].style.boxShadow = "0 0 2px 1px #cc0001";
                  check = false;
                  errArr.push(fields[i]);
                } else {
